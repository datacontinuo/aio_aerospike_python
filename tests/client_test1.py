...
class Connect(unittest.TestCase):
    ...
    async def test_append(self, key: tuple, bin: str, val: str, meta: dict, policy: dict):
        return await self.client.append(self, key: tuple, bin: str, val: str, meta, policy)
       
    async def test_apply(self, key, module, function, args=None, policy=None):
        return await self.client.apply(self, key, module, function, args=None, policy=None):

    async def test_batch_apply(self, keys: list, module: str, function: str, args: list, policy_batch: dict = None, policy_batch_apply: dict = None) -> BatchRecords:
        return await self.client.batch_apply(self, keys: list, module: str, function: str, args: list, policy_batch: dict = None, policy_batch_apply: dict = None):

    async def test_batch_get_ops(self, keys, ops, meta, policy) -> list:
    async def test_batch_get_ops(self, keys, ops, meta, policy) -> list:
    ...
    async def test_batch_operate(self, keys: list, ops: list, policy_batch: dict = None, policy_batch_write: dict = None) -> BatchRecords:
    async def test_batch_operate(self, keys: list, ops: list, policy_batch: dict = None, policy_batch_write: dict = None) -> BatchRecords:
    ...
    async def test_batch_remove(self, keys: list, policy_batch: dict = None, policy_batch_remove: dict = None) -> BatchRecords:
    async def test_batch_remove(self, keys: list, policy_batch: dict = None, policy_batch_remove: dict = None) -> BatchRecords:
    ...
    async def test_batch_write(self, batch_records: BatchRecords, policy: dict = None) -> BatchRecords:
    async def test_batch_write(self, batch_records: BatchRecords, policy: dict = None) -> BatchRecords:
    ...
    async def test_exists(self, key: tuple, policy: dict = None) -> tuple:
    async def test_exists(self, key: tuple, policy: dict = None) -> tuple:
    ...
    async def test_exists_many(self, keys: list[tuple], policy: dict = None) -> list:
    async def test_exists_many(self, keys: list[tuple], policy: dict = None) -> list:
    ...
    async def test_get(self, key: tuple, policy: dict = None) -> tuple:
    async def test_get(self, key: tuple, policy: dict = None) -> tuple:
    ...
    async def test_get_many(self, keys: list, policy: dict = None) -> list:
    async def test_get_many(self, keys: list, policy: dict = None) -> list:
    ...
    async def test_get_node_names(self) -> list:
    async def test_get_node_names(self) -> list:
    ...
    async def test_get_nodes(self) -> list:
    async def test_get_nodes(self) -> list:
    ...
    async def test_increment(self, key: tuple, bin: str, offset: Union[int, float], meta: dict=None, policy: dict=None):
    async def test_increment(self, key: tuple, bin: str, offset: Union[int, float], meta: dict=None, policy: dict=None):
    ...
    async def test_index_cdt_create(self, ns: str, set: str, bin: str, index_type, index_datatype, index_name, ctx, policy):
    async def test_index_cdt_create(self, ns: str, set: str, bin: str, index_type, index_datatype, index_name, ctx, policy):
    ...
    async def test_index_geo2dsphere_create(self, ns, set, bin, index_name: str, policy: dict=None):
    async def test_index_geo2dsphere_create(self, ns, set, bin, index_name: str, policy: dict=None):
    ...
    async def test_index_integer_create(self, ns: str, set: str, bin: str, index_name: str, policy: dict=None):
    async def test_index_integer_create(self, ns: str, set: str, bin: str, index_name: str, policy: dict=None):
    ...
    async def test_index_map_keys_create(self, ns, set, bin, index_datatype, index_name, policy=None):
    async def test_index_map_keys_create(self, ns, set, bin, index_datatype, index_name, policy=None):
    ...
    async def test_index_map_values_create(self, ns, set, bin, index_datatype, index_name, policy=None):
    async def test_index_map_values_create(self, ns, set, bin, index_datatype, index_name, policy=None):
    ...
    async def test_index_remove(self, ns, index_name, policy=None):
    async def test_index_remove(self, ns, index_name, policy=None):
    ...
    async def test_index_string_create(self, ns, set, bin, index_name, policy=None):
    async def test_index_string_create(self, ns, set, bin, index_name, policy=None):
    ...
    async def test_info(self, command: str, hosts: list=None, policy: dict=None) -> dict:
    async def test_info(self, command: str, hosts: list=None, policy: dict=None) -> dict:
    ...
    async def test_info_all(self, command: str, policy=None) -> dict:
    async def test_info_all(self, command: str, policy=None) -> dict:
    ...
    async def test_info_node(self, command, host: str, policy=None) -> str:
    async def test_info_node(self, command, host: str, policy=None) -> str:
    ...
    async def test_info_random_node(self, command, policy=None) -> str:
    async def test_info_random_node(self, command, policy=None) -> str:
    ...
    async def test_info_single_node(self, command, host: str, policy=None) -> str:
    async def test_info_single_node(self, command, host: str, policy=None) -> str:
    ...
    async def test_job_info(self, job_id, module, policy=None) -> dict:
    async def test_job_info(self, job_id, module, policy=None) -> dict:
    ...
    async def test_list_append(self, key, bin, val, meta=None, policy=None):
    async def test_list_append(self, key, bin, val, meta=None, policy=None):
    ...
    async def test_list_clear(self, key: tuple, bin: str, meta=None, policy=None):
    async def test_list_clear(self, key: tuple, bin: str, meta=None, policy=None):
    ...
    async def test_list_get(self, key, bin, index, meta=None, policy=None):
    async def test_list_get(self, key, bin, index, meta=None, policy=None):
    ...
    async def test_list_get_range(self, key, bin, index, count, meta=None, policy=None):
    async def test_list_get_range(self, key, bin, index, count, meta=None, policy=None):
    ...
    async def test_list_pop(self, key, bin, index, meta=None, policy=None):
    async def test_list_pop(self, key, bin, index, meta=None, policy=None):
    ...
    async def test_list_pop_range(self, key, bin, index, count, meta=None, policy=None):
    async def test_list_pop_range(self, key, bin, index, count, meta=None, policy=None):
    ...
    async def test_list_remove(self, key, bin, index, meta: dict=None, policy: dict=None):
    async def test_list_remove(self, key, bin, index, meta: dict=None, policy: dict=None):
    ...
    async def test_list_remove_range(self, key, bin, index, count, meta: dict=None, policy: dict=None):
    async def test_list_remove_range(self, key, bin, index, count, meta: dict=None, policy: dict=None):
    ...
    async def test_list_set(self, key, bin, index, val, meta: dict=None, policy: dict=None):
    async def test_list_set(self, key, bin, index, val, meta: dict=None, policy: dict=None):
    ...
    async def test_list_size(self, key, bin, meta: dict=None, policy: dict=None):
    async def test_list_size(self, key, bin, meta: dict=None, policy: dict=None):
    ...
    async def test_list_trim(self, key, bin, index, count, meta: dict=None, policy: dict=None):
    async def test_list_trim(self, key, bin, index, count, meta: dict=None, policy: dict=None):
    ...
    async def test_map_clear(self, key, bin, meta: dict=None, policy: dict=None):
    async def test_map_clear(self, key, bin, meta: dict=None, policy: dict=None):
    ...
    async def test_map_decrement(self, key, bin, map_key, decr, map_policy: dict=None, meta: dict=None, policy: dict=None):
    async def test_map_decrement(self, key, bin, map_key, decr, map_policy: dict=None, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_index(self, key, bin, index, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_index(self, key, bin, index, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_index_range(self, key, bin, index, range, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_index_range(self, key, bin, index, range, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_key(self, key, bin, map_key, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_key(self, key, bin, map_key, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_value_range(self, key, bin, key_list, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_value_range(self, key, bin, key_list, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_key_range(self, key, bin, map_key, range, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_key_range(self, key, bin, map_key, range, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_rank(self, key, bin, rank, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_rank(self, key, bin, rank, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_rank_range(self, key, bin, rank, range, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_rank_range(self, key, bin, rank, range, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_value(self, key, bin, val, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_value(self, key, bin, val, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_value_range(self, key, bin, value_list, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_value_range(self, key, bin, value_list, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_get_by_value_range(self, key, bin, val, range, return_type, meta: dict=None, policy: dict=None):
    async def test_map_get_by_value_range(self, key, bin, val, range, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_increment(self, key, bin, map_key, incr, map_policy: dict=None, meta: dict=None, policy: dict=None):
    async def test_map_increment(self, key, bin, map_key, incr, map_policy: dict=None, meta: dict=None, policy: dict=None):
    ...
    async def test_map_put(self, key, bin, map_key, val, map_policy: dict=None, meta: dict=None, policy: dict=None):
    async def test_map_put(self, key, bin, map_key, val, map_policy: dict=None, meta: dict=None, policy: dict=None):
    ...
    async def test_map_put_items(self, key, bin, items, map_policy: dict=None, meta: dict=None, policy: dict=None):
    async def test_map_put_items(self, key, bin, items, map_policy: dict=None, meta: dict=None, policy: dict=None):
    ...
    async def test_map_remove_by_index(self, key, bin, index, return_type, meta: dict=None, policy: dict=None):
    async def test_map_remove_by_index(self, key, bin, index, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_remove_by_index_range(self, key, bin, index, range, return_type, meta: dict=None, policy: dict=None):
    async def test_map_remove_by_index_range(self, key, bin, index, range, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_remove_by_key(self, key, bin, map_key, return_type, meta: dict=None, policy: dict=None):
    async def test_map_remove_by_key(self, key, bin, map_key, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_remove_by_key_range(self, key, bin, map_key, range, return_type, meta: dict=None, policy: dict=None):
    async def test_map_remove_by_key_range(self, key, bin, map_key, range, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_remove_by_rank(self, key, bin, rank, return_type, meta: dict=None, policy: dict=None):
    async def test_map_remove_by_rank(self, key, bin, rank, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_remove_by_rank_range(self, key, bin, rank, range, return_type, meta: dict=None, policy: dict=None):
    async def test_map_remove_by_rank_range(self, key, bin, rank, range, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_remove_by_value(self, key, bin, val, return_type, meta: dict=None, policy: dict=None):
    async def test_map_remove_by_value(self, key, bin, val, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_remove_by_value_list(self, key, bin, list, return_type, meta: dict=None, policy: dict=None):
    async def test_map_remove_by_value_list(self, key, bin, list, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_remove_by_value_range(self, key, bin, val, range, return_type, meta: dict=None, policy: dict=None):
    async def test_map_remove_by_value_range(self, key, bin, val, range, return_type, meta: dict=None, policy: dict=None):
    ...
    async def test_map_size(self, key, bin, meta: dict=None, policy: dict=None):
    async def test_map_size(self, key, bin, meta: dict=None, policy: dict=None):
    ...
    async def test_operate(self, key, list, meta: dict=None, policy: dict=None) -> tuple:
    async def test_operate(self, key, list, meta: dict=None, policy: dict=None) -> tuple:
    ...
    async def test_operate_ordered(self, key, list, meta: dict=None, policy: dict=None) -> tuple:
    async def test_operate_ordered(self, key, list, meta: dict=None, policy: dict=None) -> tuple:
    ...
    async def test_prepend(self, key, bin, val, meta: dict=None, policy: dict=None):
    async def test_prepend(self, key, bin, val, meta: dict=None, policy: dict=None):
    ...
    async def test_put(self, key: tuple, bins: dict, meta: dict=None, policy: dict=None, serializer=aerospike.SERIALIZER_PYTHON):
    ...
    def query(self, namespace: str, set: str=None) -> AioAerospikeQuery:
        ...
        '''
        return AioAerospikeQuery(self._client, namespace, set)

    async def test_query_apply(self, ns, set, predicate, module, function, args: list=None, policy: dict=None) -> int:
    ...
    async def test_remove(self, key, policy: dict=None):
    ...
    async def test_remove_bin(self, key, list, meta: dict=None, policy: dict=None):
    ...
    def scan(self, namespace: str, set: str=None) -> AioAerospikeScan:
        ...
        '''
        return AioAerospikeScan(self._client, namespace, set)

    async def test_scan_apply(self, ns: str, set: str, module: str, function: str, args: list=None, policy=None, options=None, block=None) -> int:
    ...
    async def test_scan_info(self, scan_id) -> dict:
    ...
    async def test_select(self, key: tuple, bins: list, policy: dict=None) -> tuple:
    ...
    async def test_select_many(self, keys: list, bins: list, policy: dict=None) -> list:
    ...
    async def test_set_xdr_filter(self, data_center, namespace, expression_filter, policy: dict=None) -> dict:
    ...
    async def test_touch(self, key=None, val=0, meta: dict=None, policy: dict=None):
    ...
    async def test_truncate(self, namespace, set, nanos, policy: dict=None):
    ...
    async def test_udf_get(self, module, language=None, policy=None) -> str:
    ...
    async def test_udf_list(self, policy=None) -> list:
    ...
    async def test_udf_put(self, filename, udf_type=None, policy=None):
    ...
    async def test_udf_remove(self, module, policy: dict=None):
